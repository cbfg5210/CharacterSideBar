 ...
 */
public class MyRecyclerViewSidebar extends View {
    ...
    public MyRecyclerViewSidebar(Context context) {
        super(context);
        this.init(context, null);
    }


    public MyRecyclerViewSidebar(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.init(context, attrs);
    }


    public MyRecyclerViewSidebar(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public MyRecyclerViewSidebar(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    @Override protected void onDraw(Canvas canvas) {
        ...
        if (this.sections.size() > 0) {
            ...
            for (int i = 0; i < this.sections.size(); i++) {
                MySection section = this.sections.get(i);
                    if (isPreviousImage) {
    ...
    private void showFloatView(float eventY) {
        ...
        MySection section = this.sections.get(sectionIndex);
        if (this.onTouchSectionListener == null) {
            return;
        }
            this.onTouchSectionListener.onTouchLetterSection(section);
    }
    ...
    public void setSections(List<MySection> sections) {
        this.sections.clear();
    ...
    public interface OnTouchSectionListener {
         ...
         */
        void onTouchLetterSection(MySection letterSection);
    }
}
